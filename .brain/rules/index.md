...
| 2 | [`cloudflare.md`](cloudflare.md) | `wrangler.jsonc`, `worker-configuration.d.ts`, `workers/app.ts`, `workflows/**`, `app/durable-objects/**` | Adding bindings, env vars, secrets, Workflows definition, Durable Objects, anything Workers-runtime-specific |
